...
\captionof{figure}{Particle trapped in a one-dimensional box. (\textbf{A}) the first five energy levels as a function of the quantum number $n = 1, 2, \ldots$. (\textbf{B}) The first four wave functions of the particle in a box.}
\label{fig:pib}
}
